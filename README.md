...
<img src="https://latex.codecogs.com/svg.image?$$q(x_t\mid&space;x_{t-1})=\mathcal{N}(x_t;\sqrt{1-\beta_t}x_{t-1},\beta_t\mathbf{I})$$" />
...
<img src="https://latex.codecogs.com/svg.image?$$x_t=\sqrt{1-\beta_t}x_{t-1}&plus;\sqrt{\beta_t}\epsilon\,\quad\epsilon\sim\mathcal{N}(0,\mathbf{I})$$" />
...
<img src="https://latex.codecogs.com/svg.image?$$p_\theta(x_{t-1}\mid&space;x_t)=\mathcal{N}(x_{t-1};\mu_\theta(x_t,t),\Sigma_\theta(x_t,t))$$" />
